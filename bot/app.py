...
slack_web_client = WebClient('xoxb-920803669795-932305066661-svTCKgd5PcsCihTRxNJd4gVs')
...
# start OpenCV command
def start_opencv(user_id: str, channel: str):
	# Create a new onboarding tutorial.
	onboarding_tutorial = OnboardingTutorial(channel)

	# Get the onboarding message payload
	message = onboarding_tutorial.get_resp_payload()
...
def message(payload):
	...
	if text and text.lower() == "!open":
		return start_opencv(user_id, channel_id)
